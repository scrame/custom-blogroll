...
function walk_bookmarks_plus($bookmarks, $args = '' ) {
  $defaults = array(
                    'show_updated' => 0, 'show_description' => 0, 'forcerel' => '',
...
function renderlinks_tc_hnd ($att,$content=null) {
  ...
  $wprbl_v = '2.0.0';
  extract	(shortcode_atts(array('showhide'=>0,'show_images'=>1,'always_show_names'=>0,'show_names_under_images'=>0,'excludecat'=>'','limit'=>'-1','forcerel'=>'','catorder'=>'ASC','catorderby'=>'name','order'=>'ASC','orderby'=>'name','catid' => '','catname' => '','showcatdesc' => '0','showdesc' => '0','showbrk'=> ' ','notitle'=>'0','rss_image'=>'/wp-includes/images/rss.png','show_rss'=>0), $att));
  if ($notitle=="1"){$notitletag='&categorize=0&title_li= ';} else {$notitletag='';}
  if ($showbrk=="1"){$brk="<br />";} else {$brk=' ';}
  $wprbl_s = '
					...
					<div style="padding:0 20px">
						...
						<table id="wprblhelptable"> 
							...
							<tr>
								...
								<td>Use this parameter to specify what categories should be shown by name. For example <code>[wp-blogroll catname=News]</code></td> 
							</tr>
							<tr>
								<td>catorder</td> 
							...
							<tr>
								...
								<td>A relative path the the icon that is to be used as RSS link for links. For example: /wp-includes/images/wlw/wp-icon.png</td> 
							</tr>
							<tr>
								<td>show_images</td> 
							...
							<tr>
								<td>showcatdesc</td> 
								<td class="secondrow">0 or 1 (Default:0)</td> 
								<td>Use this parameter to show the set description for each category.</td> 
							</tr>
							<tr>
								<td>showdesc</td> 
								<td class="secondrow">0 or 1 (Default:0)</td> 
								<td>Use this parameter to show the set description for each link.</td> 
							</tr>
							<tr>
								<td>showhide</td> 
								<td class="secondrow">0 or 1 (Default:0)</td> 
    ...
    ?>
      <div id="wprbl-mbox-general" class="wrap">
         ...
         <h2>WP Render Blogroll Links</h2>
            <?php wp_nonce_field('wprbl-mbox-general'); ?>
                       ...
                       <?php do_meta_boxes('WPRBL', 'side', null); ?>
                           ...
                           <?php do_meta_boxes('WPRBL', 'normal', null); ?>
                               ...
                               jQuery(document).ready( function($) {
                                   ...
                                   // postboxes setup
                                   postboxes.add_postbox_toggles('WPRBL');
                                 });
    //]]>
    </script>
        <?php
